...
describe("EmailSettings", () => {
  ...
  it("renders the heading and the docs link", () => {
    ...
    expect(screen.queryByRole("link", { name: /email alerts/i })).not.toBeInTheDocument();
  });
  ...
  it("labels each variable and shows its help text", () => {
    ...
    expect(screen.getByText(/SMTP 主机地址|Enter the SMTP host address/)).toBeInTheDocument();
    expect(screen.getByText(/SMTP 端口|Enter the SMTP port number/)).toBeInTheDocument();
  });
