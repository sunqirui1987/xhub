    ...
    <div className="w-full space-y-6">
      ...
      {!readsWholeKey && (
        <p className="text-sm text-muted-foreground" data-testid="key-savings-scope-note">
          {t("Showing your own requests on this key. A key shared across a team will have spend from other members that is not counted here.")}
        </p>
      )}
        ...
        <CardContent>
          ...
          {!hasRows && (
            <p className="py-12 text-center text-sm text-muted-foreground" data-testid="key-savings-empty">
              {isLoading ? t("Loading savings...") : t("No usage recorded for this key in this range.")}
            </p>
          )}
