...
describe("prepareModelAddRequest", () => {
  ...
  it("ignores litellm_credential_name inside XHub Params JSON", async () => {
    const formValues = {
      model_mappings: [
        {
          public_name: "Public Model",
  ...
  it("keeps litellm_credential_name from XHub Params JSON when no credential is selected", async () => {
    const formValues = {
      model_mappings: [
        {
          public_name: "Public Model",
