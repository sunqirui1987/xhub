        ...
        <div className="flex flex-wrap gap-4">
          <div style={{ maxWidth: 240 }}>
            ...
            <span className="block text-xs mt-1 text-muted-foreground">
              {t("How many identical or failing calls count as stuck. At least 2; lower reacts sooner and misfires more.")}
            </span>
          </div>
          <div style={{ maxWidth: 240 }}>
            <label className="block text-sm font-medium mb-1" htmlFor="stall-escalation-window">
              {t("Recent calls examined")}
            </label>
            <Input
            ...
            />
            <span className="block text-xs mt-1 text-muted-foreground">
              {t("How far back to look, in tool calls. Never below the repeat count, since that could never be reached.")}
            </span>
          </div>
        </div>
      )}
