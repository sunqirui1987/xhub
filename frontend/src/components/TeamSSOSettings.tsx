...
const TeamSSOSettings: React.FC<TeamSSOSettingsProps> = ({ accessToken }) => {
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      ...
      try {
        ...
        setFetchError(true);
        toast.fromError(t("Failed to fetch team settings"));
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setIsEditing(false);
      toast.success(t("Default team settings updated successfully"));
    } catch (error) {
      console.error("Error updating team settings:", error);
      toast.fromError(t("Failed to update team settings"));
    } finally {
      setSaving(false);
    }
  };
