    ...
    <>
      <div className="space-y-6">
        <div className="max-w-3xl">
          <h3 className="text-sm font-medium text-foreground">{t("Latency-Based Configuration")}</h3>
          <p className="text-xs text-muted-foreground mt-1">{t("Fine-tune latency-based routing behavior")}</p>
        </div>
