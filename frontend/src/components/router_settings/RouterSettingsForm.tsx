    ...
    <div className="w-full space-y-8 py-2">
      ...
      <div className="space-y-6">
        <div className="max-w-3xl">
          <h3 className="text-sm font-medium text-foreground">{t("Routing Settings")}</h3>
          <p className="text-xs text-muted-foreground mt-1">{t("Configure how requests are routed to deployments")}</p>
        </div>
