            ...
            <div className="w-96">
              ...
              >
                <ComboboxChips render={<div ref={anchor} />} className="w-full" aria-busy={tagsLoading}>
                  ...
                  <ComboboxChipsInput placeholder={t("All User Agents")} aria-label={t("All User Agents")} />
                  ...
                  <Card key={index}>
                    <CardContent>
                      ...
                      <div className="mt-4 space-y-3">
                        <div>
                          <p className="text-sm text-muted-foreground">{t("Success Requests")}</p>
                        ...
                        <div>
                          <p className="text-sm text-muted-foreground">{t("Total Cost")}</p>
