    ...
    <div className="mx-4">
      {publicPage == false ? (
            ...
            <div>
              ...
              <TabsContent value="models" keepMounted>
                ...
                <div className="mt-4 text-center space-y-2">
                  <p className="text-sm text-muted-foreground">
                    {t("Showing {value0} of {value1} models", { value0: (filteredData.length), value1: (modelHubData?.length || 0) })}</p>
                </div>
              </TabsContent>
              ...
              <TabsContent value="agents" keepMounted>
                <Card className="px-6">
                  ...
                  <div className="mb-4">
                    <p className="text-sm font-medium mb-2">{t("Search Agents:")}</p>
                  ...
                  <DataTable
                    ...
                    noDataMessage={
                      <HubEmptyState
                        title={agentHubData?.length ? t("No matching agents") : t("No agents yet")}
                        body={
                          agentHubData?.length
                            ? t("Adjust the search to see more agents.")
                            : t("Agents added to this proxy will appear here.")
                        }
                      />
                    }
                    size="compact"
        ...
        <Card className="mx-auto max-w-xl mt-10 px-6">
          <p className="text-xl text-center mb-2 text-foreground">{t("Public Model Hub not enabled.")}</p>
                    ...
                    {selectedAgent.skills.map((skill) => (
                      <div key={skill.id} className="border border-border rounded-sm p-4">
                        ...
                        {skill.examples && skill.examples.length > 0 && (
                          <div>
                            <p className="text-xs font-medium text-foreground">{t("Examples:")}</p>
                            <div className="flex flex-wrap gap-1 mt-1">
              ...
              <div>
                ...
                {selectedMcpServer.health_check_error && (
                  <div className="mt-2 p-2 bg-destructive/10 rounded-sm">
                    <p className="font-medium text-destructive">{t("Health Check Error:")}</p>
