            ...
            <div className="flex">
              ...
              <div className="w-1/2 border-r border-border">
                <div className="p-3 border-b border-border">
                  <span className="text-sm font-semibold text-foreground">{t("Relative time")}</span>
                </div>
              ...
              <div className="w-1/2 relative">
                <div className="p-3.5 border-b border-border">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-semibold text-foreground">{t("Start and end dates")}</span>
                  </div>
                </div>
                ...
                <div className="p-6 space-y-6 pb-20">
                  {/* Start date */}
                  <div>
                    <label className="text-sm text-foreground mb-1 block">{t("Start date")}</label>
                    <input
                      type="date"
                      value={startDate}
                  ...
                  {/* End date */}
                  <div>
                    <label className="text-sm text-foreground mb-1 block">{t("End date")}</label>
                    <input
                      type="date"
                      value={endDate}
                  ...
                  {tempValue.from && tempValue.to && validation.isValid && (
                    <div className="bg-info/10 p-3 rounded-md space-y-1">
                      <div className="text-xs text-info">
                        ...
                        {moment(tempValue.from).format(t("MMM D, YYYY [at] HH:mm:ss"))}
                      </div>
                      <div className="text-xs text-info">
                        <span className="font-medium">To:</span>{" "}
                        {moment(tempValue.to).format(t("MMM D, YYYY [at] HH:mm:ss"))}
                      </div>
                    </div>
                  )}
                </div>
