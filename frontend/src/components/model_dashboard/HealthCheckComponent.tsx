    ...
    <div>
      <div className="mb-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {isPartialSelection ? t("Run Selected Checks") : t("Run All Checks")}
            </Button>
          </div>
        </div>
      </div>
      ...
      >
        <DialogContent className="max-h-[calc(100dvh-2rem)] overflow-y-auto sm:max-w-3xl">
          <DialogHeader>
            <DialogTitle>
              {selectedErrorDetails ? t("Health Check Error - {value0}", { value0: (selectedErrorDetails.modelName) }) : t("Error Details")}
            </DialogTitle>
          ...
          <DialogHeader>
            <DialogTitle>
              {selectedSuccessDetails
                ? t("Health Check Response - {value0}", { value0: (selectedSuccessDetails.modelName) })
                : t("Response Details")}
            </DialogTitle>
