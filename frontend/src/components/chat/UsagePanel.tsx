  ...
  return (
    <div className="w-full">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 className="text-base font-semibold text-foreground mb-0.5">{t("pages.chat.yourUsage")}</h2>
          <p className="text-sm text-muted-foreground m-0">{t("pages.chat.usageSubtitle")}</p>
        </div>
