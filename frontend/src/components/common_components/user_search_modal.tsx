        ...
        <TooltipProvider>
          <form onSubmit={form.handleSubmit(handleSubmit)} noValidate>
            <Alert variant="info" className="mb-4" data-testid="member-existing-users-notice">
              <Info />
              <AlertTitle>
                {t("Search selects from users that already exist. To add someone new, ask a proxy admin to create their account first.")}
              </AlertTitle>
            </Alert>
            ...
            <FieldGroup>
              <FormField control={form.control} name="user_email" label={t("Email")}>
                {({ id, value, onChange }) =>
                  renderUserSearch("user_email", t("Search by email"), { id, value, onChange }, "member-email-search")
                }
              </FormField>
              ...
              <FormField control={form.control} name="role" label={t("Member Role")}>
                {({ id, value, onChange }) => (
