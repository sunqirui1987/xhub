      ...
      ? [
          {
            ...
            items: wildcard.map((model) => {
              ...
              return {
                label: t("All {capitalizedProvider} models", { capitalizedProvider }),
                value: model,
    ...
    <TooltipProvider>
      ...
      >
        <ComboboxChips render={<div ref={anchor} />} data-testid={dataTestId} style={style} className="w-full">
              ...
              <>
                ...
                {overflowOptions.length > 0 && (
                  <Tooltip>
                    ...
                    >{t("+{value0} more", { value0: (overflowOptions.length) })}</TooltipTrigger>
          ...
          <ComboboxChipsInput id={id} placeholder={t("Select Models")} aria-label={t("Select Models")} className="min-w-24" />
        </ComboboxChips>
