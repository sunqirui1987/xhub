    ...
    <div className="flex flex-col gap-8 py-4">
      ...
      >
        <label className="block text-sm font-semibold text-foreground mb-2">
          {t("Fallback Chain")} <span className="text-destructive">*</span>
          <span className="text-xs text-muted-foreground font-normal ml-2">
            {t("(Max {maxFallbacks} fallbacks at a time)", { maxFallbacks })}</span>
        </label>
        ...
        <div className="bg-muted rounded-xl p-4 border border-border">
          ...
          <div className="mb-4">
            <MultiSelect
              ...
              placeholder={
                canAddMoreFallbacks ? t("Select fallback models to add...") : t("Maximum {maxFallbacks} fallbacks reached", { maxFallbacks })
              }
              emptyText={t("No models found")}
          ...
          <div className="space-y-2 min-h-[100px]">
            {group.fallbackModels.length === 0 ? (
              ...
              <ol aria-label={t("Fallback chain")} className="space-y-2">
                {group.fallbackModels.map((modelValue, index) => (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      aria-label={t("Remove {modelValue}", { modelValue })}
