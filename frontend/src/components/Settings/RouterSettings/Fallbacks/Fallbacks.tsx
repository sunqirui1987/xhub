      ...
      {!hasFallbacks ? (
        <div className="rounded-lg border border-border bg-muted px-4 py-6 text-center">
          <span className="text-muted-foreground">
            {t("No fallbacks configured. Add fallbacks to automatically try another model when the primary fails.")}
          </span>
        </div>
      ) : (
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>{t("Fallbacks")}</TableHead>
                    ...
                    {canModify && (
                      <>
                        <Tooltip>
                          ...
                          <TooltipContent>{t("Test fallback")}</TooltipContent>
                        </Tooltip>
                        <Tooltip>
                          <TooltipTrigger
                            render={
                          ...
                          <TooltipContent>{t("Edit fallback")}</TooltipContent>
                        </Tooltip>
                        <Tooltip>
                          <TooltipTrigger
                            render={
                          ...
                          <TooltipContent>{t("Delete fallback")}</TooltipContent>
                        </Tooltip>
                      </>
                    )}
                  </TableCell>
