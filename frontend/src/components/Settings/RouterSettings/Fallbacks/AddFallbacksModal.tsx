        ...
        <DialogHeader>
          <div className="pb-4 border-b border-border">
            <div className="flex items-center gap-2 text-foreground">
              ...
              <div>
                <DialogTitle className="text-lg font-bold m-0">{t("Configure Model Fallbacks")}</DialogTitle>
                <p className="text-sm text-muted-foreground font-normal m-0">
                  {t("Manage multiple fallback chains for different models (up to 5 groups at a time)")}
                </p>
              </div>
            </div>
          </div>
