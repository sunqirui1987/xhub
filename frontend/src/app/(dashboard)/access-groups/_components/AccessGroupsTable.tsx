  ...
  return (
    <div className="flex flex-col items-center gap-1 py-6">
      ...
      <div className="text-sm font-medium text-foreground">
        {isFiltered ? t("pages.accessGroups.emptyFiltered") : t("pages.accessGroups.empty")}
      </div>
      <div className="text-sm text-muted-foreground">
        {isFiltered ? t("pages.accessGroups.emptyFilteredHint") : t("pages.accessGroups.emptyHint")}
      </div>
    </div>
  );
}
...
export function AccessGroupsTable({
  ...
  return (
    <DataTable
      ...
      isLoading={isLoading}
      loadingMessage={t("pages.accessGroups.loading")}
