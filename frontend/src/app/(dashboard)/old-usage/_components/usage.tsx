      ...
      <div className="w-full p-8">
        <Card>
          ...
          <CardContent className="flex flex-col items-start gap-4">
            <p className="text-sm text-muted-foreground">
              {t("SpendLogs in DB has")} {proxySettings.NUM_SPEND_LOGS_ROWS} {t("rows.")}
              <br></br>
              ...
              <div className="grid h-screen w-full grid-cols-2 gap-2">
                <div className="col-span-2">
                  <p className="mt-2 mb-2 text-lg text-muted-foreground">
                    {t("Project Spend {value0}1 - {value1}", { value0: (new Date().toLocaleString("default", { month: "long" })), value1: (new Date(new Date().getFullYear(), new Date().getMonth() + 1, 0).getDate()) })}
                  </p>
                    ...
                    <div className="grid grid-cols-2">
                      <div>
                        <p className="text-[15px] font-normal text-muted-foreground">
                          {t("API Requests {value0}", { value0: (valueFormatterNumbers(globalActivity.sum_api_requests)) })}
                        </p>
                        <AreaChart
                          className="h-40"
                      ...
                      <div>
                        <p className="text-[15px] font-normal text-muted-foreground">
                          {t("Tokens {value0}", { value0: (valueFormatterNumbers(globalActivity.sum_total_tokens)) })}
                        </p>
                        <BarChart
                          className="h-40"
                          data={globalActivity.daily_data}
