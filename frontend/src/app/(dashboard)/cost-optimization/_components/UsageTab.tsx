        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              {t("Spend on requests that invoked each tool (MCP and client-side tools); declaring a tool without invoking it does not count. A request that invoked multiple tools counts its full spend toward each, so this attributes rather than partitions spend.")}
            </p>
          </CardHeader>
          <CardContent>
            {topTools.length === 0 ? (
