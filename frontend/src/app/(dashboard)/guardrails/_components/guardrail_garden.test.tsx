...
describe("GuardrailGarden", () => {
  ...
  it("should render both sections with their descriptions", () => {
    ...
    expect(screen.getByText("XHub Content Filter")).toBeInTheDocument();
    expect(
      screen.getByText(
        "Built-in guardrails powered by XHub. Zero latency, no external dependencies, no additional cost.",
      ),
    ).toBeInTheDocument();
