    ...
    >
      ...
      <div className="px-5 pt-5 pb-3 border-b border-border shrink-0">
        <div className="flex items-center justify-between mb-1">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base font-semibold text-foreground">{t("Ask AI")}</h3>
          </div>
          <button
            onClick={handleClose}
        ...
        <p className="text-xs text-muted-foreground">{t("Ask about your spend, models, keys, and trends")}</p>
      </div>
      ...
      <div className="px-4 py-3 border-t border-border bg-card shrink-0">
        ...
        <div className="flex justify-between items-center mt-2">
          ...
          <span className="text-xs text-muted-foreground">{t("Enter to send")}</span>
        </div>
      </div>
    </div>
  );
