    ...
    <div className="search-results-content mt-1 mb-2">
      <Collapsible open={isExpanded} onOpenChange={setIsExpanded}>
        ...
        >
          ...
          {isExpanded ? t("Hide sources") : t("Show sources ({totalResults})", { totalResults })}
                          ...
                          <CollapsibleTrigger className="flex w-full items-center justify-between p-2 text-left transition-colors hover:bg-accent">
                            <div className="flex items-center gap-2 flex-1 min-w-0">
                              ...
                              <span className="text-xs font-medium text-foreground truncate">
                                {result.filename || result.file_id || t("Result {value0}", { value0: (resultIndex + 1) })}
                              </span>
                              ...
                              <div className="p-3 space-y-2">
                                ...
                                {result.attributes && Object.keys(result.attributes).length > 0 && (
                                  <div className="mt-2 pt-2 border-t border-border">
                                    <div className="text-xs text-muted-foreground mb-1 font-medium">{t("Metadata:")}</div>
