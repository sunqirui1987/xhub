                ...
                {editingProvider === row.provider ? (
                  <>
                    ...
                    <Button
                      variant="ghost"
                      size="icon-sm"
                      aria-label={t("Save discount for {displayName}", { displayName })}
                    ...
                    <Button
                      variant="ghost"
                      size="icon-sm"
                      aria-label={t("Cancel editing discount for {displayName}", { displayName })}
                  ...
                  <>
                    ...
                    <Button
                      variant="ghost"
                      size="icon-sm"
                      aria-label={t("Edit discount for {displayName}", { displayName })}
          ...
          cell: (row) => {
            ...
            return (
              <Button
                variant="ghost"
                size="icon-sm"
                aria-label={t("Remove discount for {displayName}", { displayName })}
