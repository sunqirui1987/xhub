                ...
                {editingProvider === row.provider ? (
                  <>
                    ...
                    <Button
                      variant="ghost"
                      size="icon-sm"
                      aria-label={t("Save margin for {displayName}", { displayName })}
                    ...
                    <Button
                      variant="ghost"
                      size="icon-sm"
                      aria-label={t("Cancel editing margin for {displayName}", { displayName })}
                  ...
                  <>
                    ...
                    <Button
                      variant="ghost"
                      size="icon-sm"
                      aria-label={t("Edit margin for {displayName}", { displayName })}
          ...
          cell: (row) => {
            ...
            return (
              <Button
                variant="ghost"
                size="icon-sm"
                aria-label={t("Remove margin for {displayName}", { displayName })}
