...
describe("MCPServerEdit (true passthrough warning)", () => {
  ...
  it("warns that XHub auth is disabled for a true_passthrough server", async () => {
    renderWithAuthType("true_passthrough");

    await waitFor(() => {
      expect(screen.getByText("True Passthrough disables XHub authentication for this server")).toBeInTheDocument();
    });
  });
