  ...
  return (
    <Card>
      <CardContent>
        ...
        {serverName && (title === t("Implementation Example") || title === "Configuration") && (
          <div className="mb-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <Label htmlFor={serverHeaderToggleId} className="font-normal leading-normal">
                {t("Limit tools to specific MCP servers or MCP groups by passing the")} <code>x-mcp-servers</code> {t("header")}
              </Label>
            </div>
            {useServerHeader && (
              <Alert className="mt-2" variant="info">
                <Info />
                <AlertTitle>{t("Two Options")}</AlertTitle>
                <AlertDescription>
                  <div>
                    <p>
    ...
    <div className="flex w-full flex-col gap-6">
      <div className="bg-linear-to-r from-success/15 to-success/5 p-6 rounded-lg border border-success/15">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h4 className="mb-0 text-xl font-semibold text-success">{t("LiteLLM Proxy API Integration")}</h4>
        </div>
      ...
      <div className="flex w-full flex-col gap-6">
        ...
        >
          <div className="flex w-full flex-col gap-4">
            <div>
              <span>{t("Get your Virtual Key from your LiteLLM Proxy dashboard or contact your administrator")}</span>
            </div>
            <CodeBlock title={t("Environment Variable")} code='export XHUB_API_KEY="sk-..."' copyKey="xhub-env" />
          </div>
        </FeatureCard>
    ...
    <div className="flex w-full flex-col gap-6">
      <div className="bg-linear-to-r from-info/15 to-info/5 p-6 rounded-lg border border-info/15">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h4 className="mb-0 text-xl font-semibold text-info">{t("OpenAI Responses API Integration")}</h4>
        </div>
...
--data '{
    ...
    <div className="flex w-full flex-col gap-6">
      <div className="bg-linear-to-r from-purple-50 to-blue-50 p-6 rounded-lg border border-purple-100 dark:from-purple-950 dark:to-blue-950 dark:border-purple-900">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h4 className="mb-0 text-xl font-semibold text-purple-900 dark:text-purple-100">{t("Cursor IDE Integration")}</h4>
        </div>
      ...
      <Card>
        <CardContent>
          <h5 className="mb-4 text-base font-semibold text-foreground">{t("Setup Instructions")}</h5>
          <div className="flex w-full flex-col gap-6">
            <StepCard step={1} title={t("Open Cursor Settings")}>
              <span className="text-muted-foreground">
                {t("Use the keyboard shortcut")} <code className="bg-muted px-2 py-1 rounded-sm">⇧+⌘+J</code> {t("(Mac) or")}{" "}
            ...
            <StepCard step={2} title={t("Navigate to MCP Tools")}>
              <span className="text-muted-foreground">{t("Go to the \"MCP Tools\" tab and click \"New MCP Server\"")}</span>
            </StepCard>

            <StepCard step={3} title={t("Add Configuration")}>
              <span className="mb-3 text-muted-foreground">
                {t("Copy the JSON configuration below and paste it into Cursor, then save with")}{" "}
                <code className="bg-muted px-2 py-1 rounded-sm">Cmd+S</code> {t("or")}{" "}
    ...
    <div className="flex w-full flex-col gap-6">
      <div className="bg-linear-to-r from-success/15 to-success/5 p-6 rounded-lg border border-success/15">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h4 className="mb-0 text-xl font-semibold text-success">{t("Streamable HTTP Transport")}</h4>
        </div>
        <span className="text-success">
  ...
  return (
    <div>
      <div className="flex w-full flex-col gap-6">
        <div>
          <h2 className="text-3xl font-bold text-foreground mb-3">{t("Connect to your MCP client")}</h2>
