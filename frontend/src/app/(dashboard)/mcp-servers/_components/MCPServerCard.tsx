                  ...
                  <TooltipTrigger
                    render={
                      <span className="inline-flex items-center gap-1 font-semibold text-destructive">
                        ...
                        {missing.length} {t("user field")}
                        {missing.length === 1 ? "" : "s"} {t("missing")}
                      </span>
                    }
                  />
                  <TooltipContent>
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent side="top" className="max-w-xs">
        ...
        {lastCheck && <div className="mb-1 text-xs">{t("Last check: {value0}", { value0: (new Date(lastCheck).toLocaleString()) })}</div>}
        {error && (
