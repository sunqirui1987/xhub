    ...
    <MountedFormField
      label={
        <span className="text-sm font-medium text-foreground flex items-center">
          ...
          <SimpleTooltip content={t("Paste your stdio MCP server configuration in JSON format. You can use the full mcpServers structure from config.yaml or just the inner server configuration.")}>
      ...
      rules={{
        validate: {
          ...(required ? { required: requiredRule(t("Please enter stdio configuration")) } : {}),
          json: parsesAsJson(t("Please enter valid JSON")),
        },
      }}
    >
      {(control) => (
