  ...
  <MountedFormField
    label={
      <span className="text-sm font-medium text-foreground flex items-center">
        ...
        <SimpleTooltip content={t("How the proxy authenticates to the upstream OAuth token endpoint. Client Secret Basic sends the client credentials in an HTTP Basic Authorization header; leave blank to use the default, Client Secret Post, which sends them in the request body.")}>
  ...
  >
    {(control) => {
      const placeholder = isEditing
        ? t("Leave blank to keep existing (default Client Secret Post)")
        : t("Default (Client Secret Post)");
      return (
