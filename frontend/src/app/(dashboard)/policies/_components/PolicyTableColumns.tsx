    ...
    cell: ({ row }) => {
      ...
      const versionBadge =
        row.original.versionCount > 1 ? (
          <StatusBadge tone="neutral" label={t("{value0} versions", { value0: (row.original.versionCount) })} />
        ) : undefined;
      return (
        <IdentityCell
          ...
          badge={
            isConfigPolicy ? <StatusBadge tone="neutral" label={t("Config")} tooltip={CONFIG_POLICY_HINT} /> : versionBadge
          }
