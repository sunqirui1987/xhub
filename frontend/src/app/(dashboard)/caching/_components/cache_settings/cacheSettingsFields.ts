...
export const CACHE_FIELDS: readonly CacheField[] = [
  ...
  },
  {
    ...
    defaultValue: "key",
    options: [
      { value: "key", label: t("Key (shared by all end users of the key/team/org)") },
      { value: "end_user", label: t("End user (isolated per end user)") },
    ],
  },
  {
    name: "ssl",
