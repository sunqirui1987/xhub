    ...
    <Card className="p-3">
      <div className="mb-2">
        ...
        <p className="text-muted-foreground text-xs mt-1">
          {t("Use")} <code className="bg-muted px-1 rounded-sm text-xs">{"{{variable}}"}</code> {t("syntax for template variables")}
        </p>
      </div>
            ...
            <div className="bg-muted px-2 py-1.5 border-b border-border flex items-center justify-between">
              ...
              >
                <SelectTrigger
                  ...
                  aria-label={t("Message {value0} role", { value0: (index + 1) })}
                >
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
              ...
              <div className="flex items-center gap-1">
                {messages.length > 1 && (
                  <Button
                    variant="ghost"
                    size="icon-sm"
                    aria-label={t("Remove message {value0}", { value0: (index + 1) })}
