...
const PromptsPanel: React.FC<PromptsProps> = ({ accessToken, userRole }) => {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      toast.success(t("Prompt \"{value0}\" deleted successfully from {value1}", { value0: (promptToDelete.name), value1: (promptToDelete.environment) }));
        ...
        >
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                {t("Are you sure you want to delete the {value0} copy of prompt: {value1}? This action cannot be undone.", { value0: (promptToDelete.environment), value1: (promptToDelete.name) })}</AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
