    ...
    <div className="grid grid-cols-1 gap-2 p-8 h-[80vh] w-full mt-2">
      <div className="mb-5">
        ...
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-semibold text-foreground">{t("pages.apiReference.title")}</h1>

        </div>

        <p className="mt-2 mb-2 text-sm text-muted-foreground">
          {t("LiteLLM is OpenAI Compatible. This means your API Key works with the OpenAI SDK. Just replace the base_url to point to your litellm proxy. Example Below")}
        </p>
