...
|---|---|---|---|
| `GET` | `/v1/videos` | `/v1/videos` | `proxy/video_endpoints/endpoints.py:119` |
| `POST` | `/v1/videos` | `/v1/videos` | `proxy/video_endpoints/endpoints.py:33` |
| `POST` | `/v1/videos/characters` | `/v1/videos/characters` | `proxy/video_endpoints/endpoints.py:508` |
| `GET` | `/v1/videos/characters/{character_id}` | `/v1/videos/characters/{character_id}` | `proxy/video_endpoints/endpoints.py:611` |
| `POST` | `/v1/videos/edits` | `/v1/videos/edits` | `proxy/video_endpoints/endpoints.py:717` |
| `POST` | `/v1/videos/extensions` | `/v1/videos/extensions` | `proxy/video_endpoints/endpoints.py:819` |
| `GET` | `/v1/videos/{video_id}` | `/v1/videos/{video_id}` | `proxy/video_endpoints/endpoints.py:204` |
| `GET` | `/v1/videos/{video_id}/content` | `/v1/videos/{video_id}/content` | `proxy/video_endpoints/endpoints.py:302` |
| `POST` | `/v1/videos/{video_id}/remix` | `/v1/videos/{video_id}/remix` | `proxy/video_endpoints/endpoints.py:407` |
| `GET` | `/videos` | `/videos` | `proxy/video_endpoints/endpoints.py:125` |
| `POST` | `/videos` | `/videos` | `proxy/video_endpoints/endpoints.py:39` |
| `POST` | `/videos/characters` | `/videos/characters` | `proxy/video_endpoints/endpoints.py:514` |
| `GET` | `/videos/characters/{character_id}` | `/videos/characters/{character_id}` | `proxy/video_endpoints/endpoints.py:617` |
| `POST` | `/videos/edits` | `/videos/edits` | `proxy/video_endpoints/endpoints.py:723` |
| `POST` | `/videos/extensions` | `/videos/extensions` | `proxy/video_endpoints/endpoints.py:825` |
| `GET` | `/videos/{video_id}` | `/videos/{video_id}` | `proxy/video_endpoints/endpoints.py:210` |
| `GET` | `/videos/{video_id}/content` | `/videos/{video_id}/content` | `proxy/video_endpoints/endpoints.py:308` |
| `POST` | `/videos/{video_id}/remix` | `/videos/{video_id}/remix` | `proxy/video_endpoints/endpoints.py:413` |

## 请求

`Authorization: Bearer sk-...` 或 `x-litellm-api-key`。`key_type` 为 `llm_api` 或 `default`。master key 默认不能调本族，除非 `general_settings` 显式允许。

冻结字段（不得改名）：`model`、`prompt`、`seconds`、`size; remix: prompt`。
...
冻结响应字段：`id`、`object`、`status`、`model`、`created_at`。
