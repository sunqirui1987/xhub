...
|---|---|---|---|
| `GET` | `/v1/evals` | `/v1/evals` | `proxy/openai_evals_endpoints/endpoints.py:118` |
| `POST` | `/v1/evals` | `/v1/evals` | `proxy/openai_evals_endpoints/endpoints.py:27` |
| `DELETE` | `/v1/evals/{eval_id}` | `/v1/evals/{eval_id}` | `proxy/openai_evals_endpoints/endpoints.py:397` |
| `GET` | `/v1/evals/{eval_id}` | `/v1/evals/{eval_id}` | `proxy/openai_evals_endpoints/endpoints.py:219` |
| `POST` | `/v1/evals/{eval_id}` | `/v1/evals/{eval_id}` | `proxy/openai_evals_endpoints/endpoints.py:307` |
| `POST` | `/v1/evals/{eval_id}/cancel` | `/v1/evals/{eval_id}/cancel` | `proxy/openai_evals_endpoints/endpoints.py:485` |
| `GET` | `/v1/evals/{eval_id}/runs` | `/v1/evals/{eval_id}/runs` | `proxy/openai_evals_endpoints/endpoints.py:677` |
| `POST` | `/v1/evals/{eval_id}/runs` | `/v1/evals/{eval_id}/runs` | `proxy/openai_evals_endpoints/endpoints.py:578` |
| `DELETE` | `/v1/evals/{eval_id}/runs/{run_id}` | `/v1/evals/{eval_id}/runs/{run_id}` | `proxy/openai_evals_endpoints/endpoints.py:946` |
| `GET` | `/v1/evals/{eval_id}/runs/{run_id}` | `/v1/evals/{eval_id}/runs/{run_id}` | `proxy/openai_evals_endpoints/endpoints.py:770` |
| `POST` | `/v1/evals/{eval_id}/runs/{run_id}` | `/v1/evals/{eval_id}/runs/{run_id}` | `proxy/openai_evals_endpoints/endpoints.py:857` |

## 请求

`Authorization: Bearer sk-...` 或 `x-litellm-api-key`。`key_type` 为 `llm_api` 或 `default`。master key 默认不能调本族，除非 `general_settings` 显式允许。

冻结字段（不得改名）：`name`、`data_source_config`、`testing_criteria`。
...
冻结响应字段：`id`、`object`、`name`、`status`、`created_at`。
...
Console: /cost-optimization。动作对照 [前端绑定](../../../../frontend/binding.md) 与 [页面规格](../../../../frontend/pages/README.md)。无控制台入口的路径仍须对 SDK/curl 可用。
