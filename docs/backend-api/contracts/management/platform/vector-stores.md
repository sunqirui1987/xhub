...
- Family: `mgmt.vector_stores_admin`
...
|---|---|---|---|
| `POST` | `/vector_store/delete` | `/vector_store/delete` | `proxy/vector_store_endpoints/management_endpoints.py:419` |
| `POST` | `/vector_store/info` | `/vector_store/info` | `proxy/vector_store_endpoints/management_endpoints.py:497` |
| `GET` | `/vector_store/list` | `/vector_store/list` | `proxy/vector_store_endpoints/management_endpoints.py:314` |
| `POST` | `/vector_store/new` | `/vector_store/new` | `proxy/vector_store_endpoints/management_endpoints.py:245` |
| `POST` | `/vector_store/update` | `/vector_store/update` | `proxy/vector_store_endpoints/management_endpoints.py:569` |

## 请求

master key、SSO session，或 `key_type=management` / 具备对应角色的虚拟 Key。按 `user_api_key_auth`。

冻结字段（不得改名）：`vector_store_name`、`litellm_params`、`vector_store_description`。
...
冻结响应字段：`vector_store_id`、`vector_store_name`、`created_at`。
