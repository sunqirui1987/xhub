...
|---|---|---|---|
| `POST` | `/add/allowed_ip` | `/add/allowed_ip` | `proxy/ui_crud_endpoints/proxy_setting_endpoints.py:470` |
| `POST` | `/delete/allowed_ip` | `/delete/allowed_ip` | `proxy/ui_crud_endpoints/proxy_setting_endpoints.py:534` |
| `GET` | `/get/allowed_ips` | `/get/allowed_ips` | `proxy/ui_crud_endpoints/proxy_setting_endpoints.py:457` |
